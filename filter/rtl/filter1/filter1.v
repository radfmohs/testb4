...
// Generated on: 2024-07-23 10:08:23
// -------------------------------------------------------------
...
// Response               : Bandstop
// Specification          : Fp1 47.04,Fst1 48.04,Fst2 52.04,Fp2 53.04,Ap1 2,Ast 5,Ap2 2
// Second Passband Edge   : 0.4362
// First Passband Ripple  : 2 dB
// First Stopband Edge    : 0.39508
// First Passband Edge    : 0.38686
// Stopband Atten.        : 5 dB
// Second Passband Ripple : 2 dB
// Second Stopband Edge   : 0.42798
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  // Type Definitions
  // Constants
  parameter signed [15:0] scaleconst1 = 16'b0111101001101000; //sfix16_En15
  parameter signed [15:0] coeff_b1_section1 = 16'b0100000000000000; //sfix16_En14
  parameter signed [15:0] coeff_b2_section1 = 16'b1101110011000110; //sfix16_En14
  parameter signed [15:0] coeff_b3_section1 = 16'b0100000000000000; //sfix16_En14
  parameter signed [15:0] coeff_a2_section1 = 16'b1101100100001110; //sfix16_En14
  parameter signed [15:0] coeff_a3_section1 = 16'b0011101010011000; //sfix16_En14
  parameter signed [15:0] scaleconst2 = 16'b0111101001101000; //sfix16_En15
  parameter signed [15:0] coeff_b1_section2 = 16'b0100000000000000; //sfix16_En14
  parameter signed [15:0] coeff_b2_section2 = 16'b1101110011000110; //sfix16_En14
  parameter signed [15:0] coeff_b3_section2 = 16'b0100000000000000; //sfix16_En14
  parameter signed [15:0] coeff_a2_section2 = 16'b1110001110100011; //sfix16_En14
  parameter signed [15:0] coeff_a3_section2 = 16'b0011101001110110; //sfix16_En14
  // Signals
