...
// Generated on: 2024-07-23 09:57:03
// -------------------------------------------------------------
...
// TargetDirectory: hdlsrc_961.5385_4th
...
// LoopUnrolling: on
// UseAggregatesForConst: on

// Filter Specifications:
//
// Sample Rate            : N/A (normalized frequency) 961.5385
// Response               : Bandstop
// Specification          : Fp1 47.1,Fst1 48.1,Fst2 52.1,Fp2 53.1,Ap1 2,Ast 5,Ap2 2
// Second Passband Edge   : 0.11045
// First Passband Ripple  : 2 dB
// First Stopband Edge    : 0.10005
// First Passband Edge    : 0.097968
// Stopband Atten.        : 5 dB
// Second Passband Ripple : 2 dB
// Second Stopband Edge   : 0.10837
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  // Type Definitions
  // Constants
  parameter signed [15:0] scaleconst1 = 16'b0111111010001010; //sfix16_En15
  parameter signed [15:0] coeff_b1_section1 = 16'b0100000000000000; //sfix16_En14
  parameter signed [15:0] coeff_b2_section1 = 16'b1000011011000110; //sfix16_En14
  parameter signed [15:0] coeff_b3_section1 = 16'b0100000000000000; //sfix16_En14
  parameter signed [15:0] coeff_a2_section1 = 16'b1000100010101101; //sfix16_En14
  parameter signed [15:0] coeff_a3_section1 = 16'b0011111010000000; //sfix16_En14
  parameter signed [15:0] scaleconst2 = 16'b0111111010001010; //sfix16_En15
  parameter signed [15:0] coeff_b1_section2 = 16'b0100000000000000; //sfix16_En14
  parameter signed [15:0] coeff_b2_section2 = 16'b1000011011000110; //sfix16_En14
  parameter signed [15:0] coeff_b3_section2 = 16'b0100000000000000; //sfix16_En14
  parameter signed [15:0] coeff_a2_section2 = 16'b1000011110100111; //sfix16_En14
  parameter signed [15:0] coeff_a3_section2 = 16'b0011111010011001; //sfix16_En14
  // Signals
