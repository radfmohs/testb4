...
`endif
    ...
    virtual  nnc_bioZ_interface       bioZ_mon_if;
...
`endif
        ...
        bioZ_env       = nnc_bioZ_environment::type_id::create("bioZ_env", this);
...
`endif
        ...
        nnc_config_db#(nnc_bioZ_config)::set(this, "*", "bioZ_cfg", top_cfg.bioZ_cfg);	
        ...
        if (!nnc_config_db#(virtual nnc_bioZ_interface)::get(this, "", "bioZ_mon_if", bioZ_mon_if))
          `nnc_fatal("BAF4P1_CHIP_ENV", "Can't get bioZ_mon_if")
        nnc_config_db#(virtual nnc_bioZ_interface)::set(this, "bioZ_env.*", "bioZ_mon_if", bioZ_mon_if);
