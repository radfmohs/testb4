...
//--------------------------------------------------------------------------------------
// File Name	: soc_nirs_ppg_receiver_master_single_mode_dual_led_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_nirs_ppg_receiver_master_single_mode_dual_led_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_nirs_ppg_receiver_master_single_mode_dual_led_test
`define TESTCFG soc_nirs_ppg_receiver_master_single_mode_dual_led_test_cfg
...
class `TESTCFG extends soc_nirs_ppg_receiver_master_single_mode_test_cfg;
  ...
  function new (string name = "soc_nirs_ppg_receiver_master_single_mode_dual_led_test_cfg");
    super.new(name);
...
class `TESTNAME extends soc_nirs_ppg_receiver_master_single_mode_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_nirs_ppg_receiver_master_single_mode_dual_led_test start", NNC_LOW)
   ...
   // --------------------------------------------------------
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_nirs_ppg_receiver_master_single_mode_dual_led_test end now", NNC_LOW)
