...
//--------------------------------------------------------------------------------------
// File Name	: soc_flash_bist_default_read_main_test.sv                                                   
// Project	: Nanochap ENS3                                  		        
// Description	: Testcase soc_flash_bist_default_read_main_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_flash_bist_default_read_main_test
`define TESTCFG soc_flash_bist_default_read_main_test_cfg
...
class `TESTCFG extends soc_base_test_cfg;
  ...
  function new (string name = "soc_flash_bist_default_read_main_test_cfg");
    super.new(name);
...
class `TESTNAME extends soc_base_test;
  ...
  virtual task main_phase(uvm_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_flash_bist_default_read_main_test start", UVM_LOW)
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_flash_bist_default_read_main_test end now", UVM_LOW)
...
/*
`uvm_info("", "[FLASH BIST MASTER][2] Sending Erase Command to erase at Flash", UVM_LOW);
`FLASH_BIST_MASTER_TOP.berase_10M;
`uvm_info("", "[FLASH BIST MASTER] Complete successully this phase", UVM_LOW);

`uvm_info("", "[FLASH BIST MASTER][3] Sending Read Command to read Main  of Flash", UVM_LOW);
`FLASH_BIST_MASTER_TOP.read_main_array_10M;
`uvm_info("", "[FLASH BIST MASTER] Complete successully this phase", UVM_LOW);

`uvm_info("", "[FLASH BIST MASTER][4] Sending Read Command to read and check Flash", UVM_LOW);
`FLASH_BIST_MASTER_TOP.read_check(8'hff,`PGM_WR);
`uvm_info("", "[FLASH BIST MASTER] Complete successully this phase", UVM_LOW);
*/
/*
`uvm_info("", "[FLASH BIST MASTER][5] Sending Program Command to program Main  of Flash", UVM_LOW);
`FLASH_BIST_MASTER_TOP.prgm_main_10M(8'ha5);
`uvm_info("", "[FLASH BIST MASTER] Complete successully this phase", UVM_LOW);
*/
`uvm_info("", "[FLASH BIST MASTER][6] Sending Read Command to read Main  of Flash", UVM_LOW);
`FLASH_BIST_MASTER_TOP.read_main_array_10M;
`uvm_info("", "[FLASH BIST MASTER] Complete successully this phase", UVM_LOW);
/*
`uvm_info("", "[FLASH BIST MASTER][7] Sending Read Command to read and check Flash", UVM_LOW);
`FLASH_BIST_MASTER_TOP.read_check(8'ha5,`PGM_WR);
`uvm_info("", "[FLASH BIST MASTER] Complete successully this phase", UVM_LOW);
*/
end
endtask
