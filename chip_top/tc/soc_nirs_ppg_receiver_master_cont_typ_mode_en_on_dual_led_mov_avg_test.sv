...
//--------------------------------------------------------------------------------------
// File Name	: soc_nirs_ppg_receiver_master_cont_typ_mode_en_on_dual_led_mov_avg_test.sv                                                   
// Project	: Nanochap ENS3                                  		        
// Description	: Testcase soc_nirs_ppg_receiver_master_cont_typ_mode_en_on_dual_led_mov_avg_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_nirs_ppg_receiver_master_cont_typ_mode_en_on_dual_led_mov_avg_test
`define TESTCFG soc_nirs_ppg_receiver_master_cont_typ_mode_en_on_dual_led_mov_avg_test_cfg
...
class `TESTCFG extends soc_nirs_ppg_receiver_master_cont_typ_mode_en_on_dual_led_test_cfg;
  ...
  function new (string name = "soc_nirs_ppg_receiver_master_cont_typ_mode_en_on_dual_led_mov_avg_test_cfg");
    super.new(name);
...
class `TESTNAME extends soc_nirs_ppg_receiver_master_cont_typ_mode_en_on_dual_led_test;
  ...
  virtual task main_phase(uvm_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_nirs_ppg_receiver_master_cont_typ_mode_en_on_dual_led_mov_avg_test start", UVM_LOW)
   ...
   `nnc_info("SOC_TEST - PART I", "STARTING TO CHECK THE RESET VALUE OF NORMAL REGISTERS", UVM_LOW)
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_nirs_ppg_receiver_master_cont_typ_mode_en_on_dual_led_mov_avg_test end now", UVM_LOW)
