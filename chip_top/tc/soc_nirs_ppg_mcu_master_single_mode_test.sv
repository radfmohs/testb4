...
//--------------------------------------------------------------------------------------
// File Name	: soc_nirs_ppg_mcu_master_single_mode_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_nirs_ppg_mcu_master_single_mode_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_nirs_ppg_mcu_master_single_mode_test
`define TESTCFG soc_nirs_ppg_mcu_master_single_mode_test_cfg
...
class `TESTCFG extends soc_nirs_ppg_base_test_cfg;
  ...
  function new (string name = "soc_nirs_ppg_mcu_master_single_mode_test_cfg");
    super.new(name);
...
class `TESTNAME extends soc_nirs_ppg_base_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_nirs_ppg_mcu_master_single_mode_test start", NNC_LOW)
   ...
   `nnc_info("PPG_TEST",$sformatf("gen_reg_int_active_level =%0h",`NIRS_PPG_IF.gen_reg_int_active_level ),NNC_LOW);
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_nirs_ppg_mcu_master_single_mode_test end now", NNC_LOW)
