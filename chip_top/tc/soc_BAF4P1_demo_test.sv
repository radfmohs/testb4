...
//--------------------------------------------------------------------------------------
// File Name	: soc_BAF4P1_demo_test.sv                                                   
// Project	: Nanochap ENS1p4                                  		        
// Description	: Testcase soc_BAF4P1_demo_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_BAF4P1_demo_test
`define TESTCFG soc_BAF4P1_demo_test_cfg
...
class `TESTCFG extends soc_base_test_cfg;
  ...
  function new (string name = "soc_BAF4P1_demo_test_cfg");
    super.new(name);
...
class `TESTNAME extends soc_base_test;
  ...
  virtual task main_phase(uvm_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_BAF4P1_demo_test start", UVM_LOW)
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_BAF4P1_demo_test end now", UVM_LOW)
...
//`endif
    ...
    ////------------- to write in to the SOC_CLK_CTRL_REG reg--------------//
       ...
       if(`DUT_IF.ext_clk_en === 1)
       	// enable to turn off ext clk before enter LP
       	`DUT_IF.ext_hfosc_fixed_gnd_en = 1'b1;
       `include "../tc/demo_test_force.inc"
       `uvm_info("SOC_TEST", "\n Enter Active mode", UVM_LOW);
       if(`DUT_IF.ext_clk_en === 1)
       	// disable to turn on ext clk after enter active
