...
//--------------------------------------------------------------------------------------
// File Name	: soc_spi_fifo_imeas_continuous_mode_disable_tag_test.sv                                                   
// Project	: Nanochap ENS3                                  		        
// Description	: Testcase soc_spi_fifo_imeas_continuous_mode_disable_tag_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_spi_fifo_imeas_continuous_mode_disable_tag_test
`define TESTCFG soc_spi_fifo_imeas_continuous_mode_disable_tag_test_cfg
...
class `TESTCFG extends soc_base_test_cfg;
  ...
  function new (string name = "soc_spi_fifo_imeas_continuous_mode_disable_tag_test_cfg");
    super.new(name);
...
class `TESTNAME extends soc_base_test;
  ...
  virtual task main_phase(uvm_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_spi_fifo_imeas_continuous_mode_disable_tag_test start", UVM_LOW)
...
*/
  ...
  `WR_RD_CHK_NORMAL_REG(`SOC_IMEAS_EN,wr_data,top_test_cfg.pads,top_test_cfg.mask);
    ...
    // --------------------------------------------------------
    //#10000ns;
    `nnc_info("SOC_TEST", "soc_spi_fifo_imeas_continuous_mode_disable_tag_test end now", UVM_LOW)
