...
//--------------------------------------------------------------------------------------
// File Name	: soc_flash_bist_rdn_test.sv                                                   
// Project	: Nanochap ENS3                                  		        
// Description	: Testcase soc_flash_bist_rdn_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_flash_bist_rdn_test
`define TESTCFG soc_flash_bist_rdn_test_cfg
...
class `TESTCFG extends soc_base_test_cfg;
  ...
  function new (string name = "soc_flash_bist_rdn_test_cfg");
    super.new(name);
...
class `TESTNAME extends soc_base_test;
  ...
  virtual task main_phase(uvm_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_flash_bist_rdn_test start", UVM_LOW)
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_flash_bist_rdn_test end now", UVM_LOW)
...
`FLASH_BIST_MASTER_TOP.read_check_rdn(8'hff,`PGM_WR);
`uvm_info("", "[FLASH BIST MASTER] Complete successully this phase", UVM_LOW);

`uvm_info("", "[FLASH BIST MASTER][3] Sending Program Command to program RDN of Flash", UVM_LOW);
