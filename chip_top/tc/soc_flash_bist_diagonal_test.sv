...
//--------------------------------------------------------------------------------------
// File Name	: soc_flash_bist_diagonal_test.sv                                                   
// Project	: Nanochap ENS3                                  		        
// Description	: Testcase soc_flash_bist_diagonal_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_flash_bist_diagonal_test
`define TESTCFG soc_flash_bist_diagonal_test_cfg
...
class `TESTCFG extends soc_base_test_cfg;
  ...
  function new (string name = "soc_flash_bist_diagonal_test_cfg");
    super.new(name);
...
class `TESTNAME extends soc_base_test;
  ...
  virtual task main_phase(uvm_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_flash_bist_diagonal_test start", UVM_LOW)
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_flash_bist_diagonal_test end now", UVM_LOW)
...
`uvm_info("", "[FLASH BIST MASTER][2] Sending Serial Erase Command to erase Main of Flash", UVM_LOW);
`FLASH_BIST_MASTER_TOP.serase_main_10M;
`uvm_info("", "[FLASH BIST MASTER] Complete successully this phase", UVM_LOW);

`uvm_info("", "[FLASH BIST MASTER][3] Sending Program Command to program Diag Main of Flash", UVM_LOW);
`FLASH_BIST_MASTER_TOP.prgm_diag_main_10M(8'h55);
`uvm_info("", "[FLASH BIST MASTER] Complete successully this phase", UVM_LOW);
#1000000;
`uvm_info("", "[FLASH BIST MASTER][4] Sending Read Command to read main array of Flash", UVM_LOW);
`FLASH_BIST_MASTER_TOP.read_main_array_10M;
`uvm_info("", "[FLASH BIST MASTER] Complete successully this phase", UVM_LOW);
#1000000;
`uvm_info("", "[FLASH BIST MASTER][5] Sending Read Command to read and check of Flash", UVM_LOW);
