...
//--------------------------------------------------------------------------------------
// File Name	: soc_BAF4P1_demo_test_min.sv                                                   
// Project	: Nanochap ENS1p4                                  		        
// Description	: Testcase soc_BAF4P1_demo_test_min                                             
...
// -------------------------------------------------
`define TESTNAME soc_BAF4P1_demo_test_min
`define TESTCFG soc_BAF4P1_demo_test_min_cfg
...
class `TESTCFG extends soc_base_test_cfg;
  ...
  function new (string name = "soc_BAF4P1_demo_test_min_cfg");
    super.new(name);
  ...
  // spi_sclk_freq
  constraint c_spi_sclk_freq  { soft spi_sclk_freq == 10; }//10Khz SPI min clk
...
class `TESTNAME extends soc_base_test;
  ...
  virtual task main_phase(uvm_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_BAF4P1_demo_test_min start", UVM_LOW)
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_BAF4P1_demo_test_min end now", UVM_LOW)
