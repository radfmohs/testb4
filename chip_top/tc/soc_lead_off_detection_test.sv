...
//--------------------------------------------------------------------------------------
// File Name	: soc_lead_off_detection_test.sv                                                   
// Project	: Nanochap ENS3                                  		        
// Description	: Testcase soc_lead_off_detection_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_lead_off_detection_test
`define TESTCFG soc_lead_off_detection_test_cfg
...
class `TESTCFG extends soc_base_test_cfg;
  ...
  function new (string name = "soc_lead_off_detection_test_cfg");
    super.new(name);
...
class `TESTNAME extends soc_base_test;
  ...
  virtual task main_phase(uvm_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_lead_off_detection_test start", UVM_LOW)
   ...
   `nnc_info("SOC_TEST - PART I", "STARTING TO CHECK THE RESET VALUE OF NORMAL REGISTERS", UVM_LOW)
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_lead_off_detection_test end now", UVM_LOW)
