...
//--------------------------------------------------------------------------------------
// File Name	: soc_nirs_ppg_receiver_master_cont_fast_mode_amb_mode_en_mov_avg_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_nirs_ppg_receiver_master_cont_fast_mode_amb_mode_en_mov_avg_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_nirs_ppg_receiver_master_cont_fast_mode_amb_mode_en_mov_avg_test
`define TESTCFG soc_nirs_ppg_receiver_master_cont_fast_mode_amb_mode_en_mov_avg_test_cfg
...
class `TESTCFG extends soc_nirs_ppg_receiver_master_cont_fast_mode_test_cfg;
  ...
  function new (string name = "soc_nirs_ppg_receiver_master_cont_fast_mode_amb_mode_en_mov_avg_test_cfg");
    super.new(name);
...
class `TESTNAME extends soc_nirs_ppg_receiver_master_cont_fast_mode_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_nirs_ppg_receiver_master_cont_fast_mode_amb_mode_en_mov_avg_test", NNC_LOW)
   ...
   `nnc_info("SOC_TEST", "Set either signle or dual led control signal !!!\n", NNC_LOW)
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "\nsoc_nirs_ppg_receiver_master_cont_fast_mode_amb_mode_en_mov_avg_test end now\n", NNC_LOW)
