...
//--------------------------------------------------------------------------------------
// File Name	: soc_flash_bist_rdn_inv_checkboard_test.sv                                                   
// Project	: Nanochap ENS3                                  		        
// Description	: Testcase soc_flash_bist_rdn_inv_checkboard_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_flash_bist_rdn_inv_checkboard_test
`define TESTCFG soc_flash_bist_rdn_inv_checkboard_test_cfg
...
class `TESTCFG extends soc_base_test_cfg;
  ...
  function new (string name = "soc_flash_bist_rdn_inv_checkboard_test_cfg");
    super.new(name);
...
class `TESTNAME extends soc_base_test;
  ...
  virtual task main_phase(uvm_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_flash_bist_rdn_inv_checkboard_test start", UVM_LOW)
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_flash_bist_rdn_inv_checkboard_test end now", UVM_LOW)
...
`uvm_info("", "[FLASH BIST MASTER][2] Sending Serial Erase Command to to erase RDN of Flash", UVM_LOW);
`FLASH_BIST_MASTER_TOP.serase_RDN_10M;
`uvm_info("", "[FLASH BIST MASTER] Complete successully this phase", UVM_LOW);

`uvm_info("", "[FLASH BIST MASTER][3] Sending Program Command to program ICKB RDN of Flash", UVM_LOW);
`FLASH_BIST_MASTER_TOP.prgm_ickb_RDN_10M(8'h0a);
`uvm_info("", "[FLASH BIST MASTER] Complete successully this phase", UVM_LOW);

`uvm_info("", "[FLASH BIST MASTER][4] Sending Read Command to read RDN of Flash", UVM_LOW);
`FLASH_BIST_MASTER_TOP.read_RDN_10M;
`uvm_info("", "[FLASH BIST MASTER] Complete successully this phase", UVM_LOW);

`uvm_info("", "[FLASH BIST MASTER][5] Sending Read Command to read and check RDN of Flash", UVM_LOW);
