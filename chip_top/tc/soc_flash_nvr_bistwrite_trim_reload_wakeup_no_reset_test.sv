...
//--------------------------------------------------------------------------------------
// File Name	: soc_flash_nvr_bistwrite_trim_reload_wakeup_no_reset_test.sv                                                   
// Project	: Nanochap SOC                                  		        
// Description	: Testcase soc_flash_nvr_bistwrite_trim_reload_wakeup_no_reset_test                                             
// Designer	: ddang@nanochap.com                                                                 
// Date		: 29-11-1623                                                                     
// Revision	: 0.1 Initial version created by script                                 
--------------------------------------------------------------------------------------*/
`define TESTNAME soc_flash_nvr_bistwrite_trim_reload_wakeup_no_reset_test
`define TESTCFG soc_flash_nvr_bistwrite_trim_reload_wakeup_no_reset_test_cfg
...
class `TESTCFG extends soc_base_test_cfg;
  ...
  function new (string name = "soc_flash_nvr_bistwrite_trim_reload_wakeup_no_reset_test_cfg");
    super.new(name);    
  endfunction: new
...
class `TESTNAME extends soc_base_test;
  ...
  virtual task main_phase(uvm_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_flash_nvr_bistwrite_trim_reload_wakeup_no_reset_test start", UVM_LOW)
