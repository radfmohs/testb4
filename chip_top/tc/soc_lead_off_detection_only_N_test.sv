...
//--------------------------------------------------------------------------------------
// File Name	: soc_lead_off_detection_only_N_test.sv                                                   
// Project	: Nanochap ENS3                                  		        
// Description	: Testcase soc_lead_off_detection_only_N_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_lead_off_detection_only_N_test
`define TESTCFG soc_lead_off_detection_only_N_test_cfg

class `TESTCFG extends soc_base_lead_off_detection_test_cfg;

  `nnc_object_utils(`TESTCFG)

  function new (string name = "soc_lead_off_detection_only_N_test_cfg");
    super.new(name);
...
class `TESTNAME extends soc_base_lead_off_detection_test;
  ...
  virtual function void build_phase(nnc_phase phase);
    ...
    only_n = 1;
    `nnc_info(get_full_name(), $sformatf(" only_n=%0d",only_n),UVM_LOW);
  endfunction
  ...
  virtual task main_phase(uvm_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_lead_off_detection_only_N_test start", UVM_LOW)
    ...
    // --------------------------------------------------------
    `nnc_info("SOC_TEST", "soc_lead_off_detection_only_N_test end now", UVM_LOW)
