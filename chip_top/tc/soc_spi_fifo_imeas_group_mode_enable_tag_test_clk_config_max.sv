...
//--------------------------------------------------------------------------------------
// File Name	: soc_spi_fifo_imeas_group_mode_enable_tag_test_clk_config_max.sv                                                   
// Project	: Nanochap ENS3                                  		        
// Description	: Testcase soc_spi_fifo_imeas_group_mode_enable_tag_test_clk_config_max                                             
...
// -------------------------------------------------
`define TESTNAME soc_spi_fifo_imeas_group_mode_enable_tag_test_clk_config_max
`define TESTCFG soc_spi_fifo_imeas_group_mode_enable_tag_test_clk_config_max_cfg
...
class `TESTCFG extends soc_base_test_cfg;
  ...
  function new (string name = "soc_spi_fifo_imeas_group_mode_enable_tag_test_clk_config_max_cfg");
    super.new(name);
...
class `TESTNAME extends soc_base_test;
  ...
  virtual task main_phase(uvm_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_spi_fifo_imeas_group_mode_enable_tag_test_clk_config_max start", UVM_LOW)
...
/*  
  ...
  `WR_RD_CHK_NORMAL_REG(`SOC_IMEAS_EN,wr_data,top_test_cfg.pads,top_test_cfg.mask);
    ...
    // --------------------------------------------------------
    //#10000ns;
    `nnc_info("SOC_TEST", "soc_spi_fifo_imeas_group_mode_enable_tag_test_clk_config_max end now", UVM_LOW)
