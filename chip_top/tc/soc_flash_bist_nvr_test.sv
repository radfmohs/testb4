...
//--------------------------------------------------------------------------------------
// File Name	: soc_flash_bist_nvr_test.sv                                                   
// Project	: Nanochap ENS3                                  		        
// Description	: Testcase soc_flash_bist_nvr_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_flash_bist_nvr_test
`define TESTCFG soc_flash_bist_nvr_test_cfg
...
class `TESTCFG extends soc_base_test_cfg;
  ...
  function new (string name = "soc_flash_bist_nvr_test_cfg");
    super.new(name);
...
class `TESTNAME extends soc_base_test;
  ...
  virtual task main_phase(uvm_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_flash_bist_nvr_test start", UVM_LOW)
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_flash_bist_nvr_test end now", UVM_LOW)
...
`uvm_info("", "[FLASH BIST MASTER][2] Sending Serial Erase Command to to erase NVR of Flash", UVM_LOW);
`FLASH_BIST_MASTER_TOP.serase_1st_NVR_10M;
`uvm_info("", "[FLASH BIST MASTER] Complete successully this phase", UVM_LOW);

`uvm_info("", "[FLASH BIST MASTER][4] Sending Read Command to read NVR of Flash", UVM_LOW);
`FLASH_BIST_MASTER_TOP.read_NVR_10M;
`uvm_info("", "[FLASH BIST MASTER] Complete successully this phase", UVM_LOW);

`uvm_info("", "[FLASH BIST MASTER][3] Sending Program Command to program NVR of Flash", UVM_LOW);
`FLASH_BIST_MASTER_TOP.prgm_1st_NVR_10M(top_test_cfg.wdata);
`uvm_info("", "[FLASH BIST MASTER] Complete successully this phase", UVM_LOW);
...
`uvm_info("", "[FLASH BIST MASTER][3] Sending diag Program Command to program NVR of Flash", UVM_LOW);
assert(top_test_cfg.randomize());
`FLASH_BIST_MASTER_TOP.prgm_diag_NVR_10M(top_test_cfg.wdata);
`uvm_info("", "[FLASH BIST MASTER] Complete successully this phase", UVM_LOW);
...
`uvm_info("", "[FLASH BIST MASTER][5] Sending Read Command to Read and Check NVR of Flash", UVM_LOW);
